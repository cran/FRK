...
%Using basis-function decomposition, we let $\upsilon_1(\svec) = (\phi_1(\svec),\dots,\phi_r(\svec))\etab \equiv \phib(\svec)'\etab$. Then,
...
%Any bias in the measurement is represented by the spatially independent systematic error $\deltab \equiv (\delta_1,\dots,\delta_N)'$ with individual variances,
